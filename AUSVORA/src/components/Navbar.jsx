...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <nav className="hidden md:flex items-center gap-1">
            <a
              href="/"
              className="group relative px-5 py-2.5 text-gray-300 font-medium rounded-lg transition-all duration-300 hover:text-white"
            >
            ...
            >
              ...
              {/* Dropdown Menu */}
              <div
                className={`absolute top-full left-0 mt-2 w-64 transform transition-all duration-300 ${
                  servicesOpen
              ...
              >
                <div className="bg-gray-800/95 backdrop-blur-xl rounded-xl shadow-2xl shadow-purple-500/20 border border-gray-700/50 overflow-hidden">
                  <a
                    href="/ecommerce"
                    className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:text-white hover:bg-gradient-to-r hover:from-purple-600/20 hover:to-pink-600/20 transition-all duration-300"
                  >
          ...
          <div className="md:hidden">
            ...
            >
              <div className="relative w-6 h-6">
                <span
                  className={`absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-purple-400 to-pink-400 transform transition-all duration-300 ${
                    isOpen ? "rotate-45 translate-y-2.5" : ""
                  }`}
                ></span>
                <span
                  className={`absolute inset-x-0 top-1/2 -translate-y-1/2 h-0.5 bg-gradient-to-r from-pink-400 to-orange-400 transition-all duration-300 ${
                    isOpen ? "opacity-0 scale-x-0" : ""
                  }`}
                ></span>
                <span
                  className={`absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-orange-400 to-purple-400 transform transition-all duration-300 ${
                    isOpen ? "-rotate-45 -translate-y-2.5" : ""
                  }`}
                ></span>
              </div>
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute inset-x-0 top-full transform transition-all duration-500 ${
          isOpen
        ...
        <div className="bg-gray-900/95 backdrop-blur-2xl border-t border-gray-800 shadow-2xl">
          <nav className="p-6 space-y-4">
            <a
              href="/"
              onClick={toggleMenu}
              className="block px-4 py-3 text-gray-300 font-medium rounded-lg bg-gray-800/50 hover:bg-gray-800 hover:text-white transition-all duration-300"
            >
              Home
            </a>
            ...
            <div className="space-y-2">
              <p className="px-4 py-2 text-gray-500 text-sm font-semibold uppercase tracking-wider">
                Services
              </p>
              <a
                href="/ecommerce"
                onClick={toggleMenu}
                className="flex items-center gap-3 px-4 py-3 text-gray-300 font-medium rounded-lg bg-gray-800/30 hover:bg-gray-800/50 hover:text-white transition-all duration-300"
              >
                <ShoppingBag className="w-5 h-5 text-purple-400" />
            ...
            <a
              href="/contact"
              onClick={toggleMenu}
              className="block w-full text-center px-4 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:shadow-lg transition-all duration-300"
            >
              Get Started
            </a>
          </nav>
